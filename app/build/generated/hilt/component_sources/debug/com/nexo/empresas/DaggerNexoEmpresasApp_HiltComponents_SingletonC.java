...
import com.nexo.empresas.data.repository.ChequesRepositoryImpl;
import com.nexo.empresas.data.repository.ContactosRepositoryImpl;
import com.nexo.empresas.data.repository.CuentasCorrientesRepositoryImpl;
import com.nexo.empresas.data.repository.DashboardRepositoryImpl;
import com.nexo.empresas.data.repository.DocumentosRepositoryImpl;
import com.nexo.empresas.data.repository.EmpresasRepositoryImpl;
...
import com.nexo.empresas.presentation.alertas.AlertasViewModel;
import com.nexo.empresas.presentation.alertas.AlertasViewModel_HiltModules;
import com.nexo.empresas.presentation.alertas.AlertasViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import com.nexo.empresas.presentation.alertas.AlertasViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
import com.nexo.empresas.presentation.auth.AuthViewModel;
import com.nexo.empresas.presentation.auth.AuthViewModel_HiltModules;
import com.nexo.empresas.presentation.auth.AuthViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import com.nexo.empresas.presentation.auth.AuthViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
import com.nexo.empresas.presentation.cheques.ChequesViewModel;
import com.nexo.empresas.presentation.cheques.ChequesViewModel_HiltModules;
import com.nexo.empresas.presentation.cheques.ChequesViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import com.nexo.empresas.presentation.cheques.ChequesViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
import com.nexo.empresas.presentation.contactos.ContactosViewModel;
import com.nexo.empresas.presentation.contactos.ContactosViewModel_HiltModules;
import com.nexo.empresas.presentation.contactos.ContactosViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import com.nexo.empresas.presentation.contactos.ContactosViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
import com.nexo.empresas.presentation.cuentas.CuentasCorrientesViewModel;
import com.nexo.empresas.presentation.cuentas.CuentasCorrientesViewModel_HiltModules;
import com.nexo.empresas.presentation.cuentas.CuentasCorrientesViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import com.nexo.empresas.presentation.cuentas.CuentasCorrientesViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
import com.nexo.empresas.presentation.dashboard.DashboardViewModel;
import com.nexo.empresas.presentation.dashboard.DashboardViewModel_HiltModules;
import com.nexo.empresas.presentation.dashboard.DashboardViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import com.nexo.empresas.presentation.dashboard.DashboardViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
import com.nexo.empresas.presentation.documentos.AddDocumentoViewModel;
import com.nexo.empresas.presentation.documentos.AddDocumentoViewModel_HiltModules;
import com.nexo.empresas.presentation.documentos.AddDocumentoViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import com.nexo.empresas.presentation.documentos.AddDocumentoViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
import com.nexo.empresas.presentation.documentos.DocumentosViewModel;
import com.nexo.empresas.presentation.documentos.DocumentosViewModel_HiltModules;
import com.nexo.empresas.presentation.documentos.DocumentosViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import com.nexo.empresas.presentation.documentos.DocumentosViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
import com.nexo.empresas.presentation.dte.DteViewModel;
...
import com.nexo.empresas.presentation.empresas.EmpresasViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
import com.nexo.empresas.presentation.graficos.GraficosViewModel;
import com.nexo.empresas.presentation.graficos.GraficosViewModel_HiltModules;
import com.nexo.empresas.presentation.graficos.GraficosViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import com.nexo.empresas.presentation.graficos.GraficosViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
import com.nexo.empresas.presentation.hub.HubViewModel;
import com.nexo.empresas.presentation.hub.HubViewModel_HiltModules;
import com.nexo.empresas.presentation.hub.HubViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import com.nexo.empresas.presentation.hub.HubViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
import com.nexo.empresas.presentation.scanner.ScannerViewModel;
import com.nexo.empresas.presentation.scanner.ScannerViewModel_HiltModules;
import com.nexo.empresas.presentation.scanner.ScannerViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import com.nexo.empresas.presentation.scanner.ScannerViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
import com.nexo.empresas.presentation.settings.SettingsViewModel;
...
import com.nexo.empresas.presentation.tutorial.OnboardingViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
import com.nexo.empresas.presentation.tutorial.TutorialListViewModel;
import com.nexo.empresas.presentation.tutorial.TutorialListViewModel_HiltModules;
import com.nexo.empresas.presentation.tutorial.TutorialListViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import com.nexo.empresas.presentation.tutorial.TutorialListViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
...
public final class DaggerNexoEmpresasApp_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends NexoEmpresasApp_HiltComponents.ViewModelC {
    ...
    Provider<DteViewModel> dteViewModelProvider;
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.nexo.empresas.presentation.documentos.AddDocumentoViewModel
          ...
          case 5: // com.nexo.empresas.presentation.cuentas.CuentasCorrientesViewModel
          ...
          case 6: // com.nexo.empresas.presentation.dashboard.DashboardViewModel
          return (T) new DashboardViewModel(singletonCImpl.dashboardRepositoryImplProvider.get());

          case 7: // com.nexo.empresas.presentation.documentos.DocumentosViewModel
  ...
  private static final class SingletonCImpl extends NexoEmpresasApp_HiltComponents.SingletonC {
    ...
    Provider<DteRemoteDataSource> provideDteRemoteDataSourceProvider;

    Provider<DteRepository> provideDteRepositoryProvider;
